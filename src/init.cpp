...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BlueDragon747/Blakecoin>";
    const std::string URL_WEBSITE = "<https://blakecoin.org>";
