...
const char * const BITCOIN_CONF_FILENAME = "blakecoin.conf";
const char * const BITCOIN_PID_FILENAME = "blakecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Blakecoin";
#else
    // Unix
